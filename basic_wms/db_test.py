...
print("  #25", db_api.ItemBatchCRUD.get_item_batch(item_batch1_id)['warehouse_id'] == 1)
print("  #26", db_api.ItemBatchCRUD.get_item_batch(item_batch1_id)['supplier_id'] == 1)
print("  #27", db_api.ItemBatchCRUD.get_item_batch(item_batch1_id)['item_type_id'] == 1)
...
print("  #29", db_api.ItemBatchCRUD.get_item_batch(item_batch1_id)['warehouse_id'] == 2)
print("  #30", db_api.ItemBatchCRUD.get_item_batch(item_batch1_id)['supplier_id'] == 3)
print("  #31", db_api.ItemBatchCRUD.get_item_batch(item_batch1_id)['item_type_id'] == 2)
